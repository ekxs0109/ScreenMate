...
export function ViewerList({
  ...
  const onlineViewerCount = viewers.filter((viewer) => viewer.online !== false).length;
  ...
  return (
    <div className={cn("flex flex-col h-full bg-zinc-50 dark:bg-zinc-950/40 relative", className)} data-testid="popup-viewer-roster">
      ...
      {viewers.length === 0 ? (
        <div className="flex flex-1 flex-col items-center justify-center p-3 text-center animate-in fade-in duration-500">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <div
                      className={cn(
                        ...
                        viewer.online !== false ? "bg-green-500 shadow-[0_0_6px_rgba(34,197,94,0.6)]" : "bg-zinc-300"
                      )}
                    />
                  </div>
